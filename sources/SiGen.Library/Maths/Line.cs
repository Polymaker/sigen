...
namespace SiGen.Maths
{
    public struct Line
    {
        ...
        public const double TOLERENCE = 0.0001d;
        ...
        public bool IsHorizontal { get { return !IsVertical && A.EqualOrClose(0, TOLERENCE); } }
        ...
        public static bool operator ==(Line left, Line right)
        {
            if (left.IsVertical != right.IsVertical)
                return false;
            if (left.IsVertical)
                return left.X.EqualOrClose(right.X, 0.001);
       
            return NumberExtensions.EqualOrClose(left.A, right.A, TOLERENCE) && NumberExtensions.EqualOrClose(left.B, right.B, TOLERENCE);
        }
        ...
        public static bool AreParallel(Line l1, Line l2)
        {
            ...
            return NumberExtensions.EqualOrClose(l1.A, l2.A, TOLERENCE);
        }
        ...
        public static bool ArePerpendicular(Line l1, Line l2)
        {
            if ((l1.IsHorizontal && l2.IsVertical) || (l2.IsHorizontal && l1.IsVertical))
                return true;
            return NumberExtensions.EqualOrClose((1d / l1.A) * -1, l2.A, TOLERENCE) || NumberExtensions.EqualOrClose((1d / l2.A) * -1, l1.A, TOLERENCE);
        }
